  ...
  return (
    <div className="flex items-center justify-center flex-col">
      <div className={cn(
        ...
        <div className="text-3xl md:text-6xl bg-gradient-to-r from-fuchsia-600 to-pink-600 text-white p-5 rounded-md pb-4 w-fit">
          work forward.
        </div>
      </div>
      <div className={cn(
      ...
      <Button className="mt-6 transition-all duration-200 hover:scale-105" size="lg" asChild>
        <Link href="/sign-up">
